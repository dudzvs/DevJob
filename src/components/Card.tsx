...
const Card = ({ icon, company, postedAt, contract, position, location, bgColor }: CardTypes) => {
	return (
		<div className="relative flex w-full cursor-pointer flex-col items-center justify-start rounded-2xl p-10 align-text-top active:bg-blue-midnight lg:max-w-[600px]">
			<div
